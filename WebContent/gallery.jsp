...
<!-- CSS
	================================================== -->
<link rel="stylesheet" href="./admin/indexAdmin_files/zerogrid.css">
<link rel="stylesheet" href="./admin/indexAdmin_files/style.css">

<!-- Custom Fonts -->
<link href="./admin/indexAdmin_files/font-awesome.min.css"
	rel="stylesheet" type="text/css">


<link rel="stylesheet" href="./admin/indexAdmin_files/menu.css">
<script src="./admin/indexAdmin_files/jquery1111.min.js"
	type="text/javascript"></script>
<script src="./admin/indexAdmin_files/script.js"></script>

<!-- Owl Carousel Assets -->
<link href="./admin/indexAdmin_files/owl.carousel.css" rel="stylesheet">
		...
		<header class="">
			...
			<div id="cssmenu" class="align-center">
				...
				<ul>
					...
					<li><a href="login2.jsp"><span>Login</span></a></li>
