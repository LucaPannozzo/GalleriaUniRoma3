		...
		<section id="container">
			<div class="wrap-container">
				...
				<section class="content-box box-1">
					<form method="POST" action="ControllerAutori">
						<table>
							<tr>
								<td align="right">Nome*:</td>
								<td><input type="text" name="nomeT" autofocus="autofocus"
									value="${autore.nome}" /></td>
								<td>${errName}</td>
							</tr>
							<tr>
								<td align="right">Cognome*:</td>
								<td><input type="text" name="cognomeT"
									value="${autore.cognome}" /></td>
								<td>${errCognome}</td>
							</tr>
							<tr>
								<td align="right">Nazione :</td>
								<td><input type="text" name="nazioneT"
									value="${autore.nazione}" /></td>

							</tr>
							<tr>
								<td align="right">Data di nascita *:</td>
								<td><input type="date" name="dataNascitaT"
									placeholder="yyyy-mm-dd" value="${autore.dataNascita}" /></td>
								<td>${errDate1}</td>
							</tr>
							<tr>
								<td align="right">Data di morte :</td>
								<td><input type="date" name="dataMorteT"
									placeholder="yyyy-mm-dd" value="${autore.dataMorte}" /></td>
								<td>${errDate}</td>
							</tr>
							<tr>
					...
					${AutoreContenuto} ${AutoreInserito}
				</section>
